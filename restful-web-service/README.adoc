...
http://localhost:8080/restful-web-service/customers/

http://localhost:8080/restful-web-service/v3/api-docs

http://localhost:8080/restful-web-service/swagger-ui/index.html
